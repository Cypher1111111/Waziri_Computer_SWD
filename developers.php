                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<hr>
                                <div class="span3">
										<center>
										<img id="developers" src="admin/images/IMG_1399.HEIC" class="img-circle">
										<hr>
										<p>Name: Edeh David Chidera</p>
										<p>Address: Kontagora, Niger State</p>
										<p>Email: Davidedeh08@gmail.com</p>
										<p>Position: Programmer</p>
										<p>Cell Phone: 07030177337</p>
										</center>
								</div>
                                <div class="span3">
															<center>
								<img id="developers" src="admin/images/IMG_0408.jpeg" class="img-circle">
								<hr>
